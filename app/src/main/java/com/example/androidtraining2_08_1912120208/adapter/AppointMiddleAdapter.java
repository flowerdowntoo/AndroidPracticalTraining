...
public class AppointMiddleAdapter extends BaseMultiItemQuickAdapter<rentalDto, BaseViewHolder> {
    private long rentalId;
    private long id;
    public AppointMiddleAdapter(List<rentalDto> data) {
        super(data);
        // 绑定 layout 对应的 type
//         addItemType(1, R.layout.item_home1);
        addItemType(2, R.layout.item_appointment_middle);
